...
%% detect_rogue_ap  â€“  Stage-1: Physical-Layer Beacon Fingerprinting
%
...
%    .detected     â€“ per-second boolean detection flag (Stage-1 only)
%    .score        â€“ continuous anomaly score [0,1]
%    .detectedTime â€“ first detection timestamp (s)
...
for k = 1:N
    ...
    %â”€â”€ Feature 1: Unexpected beacon burst (rogue beacons present) â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if sim.rogueBeacons(k) > 5
        s = s + 0.4;
    end

    %â”€â”€ Feature 2: Rogue-to-legit beacon ratio exceeds threshold â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ratio = sim.rogueBeacons(k) / max(sim.legitBeacons(k), 1);
    if ratio > 0.3
        s = s + 0.3 * min(ratio, 1);
    end

    %â”€â”€ Feature 3: Simultaneous same-SSID detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
%â”€â”€ Thresholding with small lag (processing latency ~2 s) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
threshold    = 0.45;
